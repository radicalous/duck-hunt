...
namespace DuckHuntCommon
{
    ...
    class StaticBackground
    {
        ...
        public void Initialize(Texture2D texture1, int screenWidth, int screenHeight, int speed)
        {
            ...
            for (int i = 0; i < positions.Length; i++)
            {
                ...
                positions[i] = new Vector2(i * texture.Width, 0);
                positions[i].Y = _screenHeight - texture.Height;
        ...
        public void Draw(SpriteBatch spriteBatch, float depth)
        {
            ...
            for (int i = 0; i < positions.Length; i++)
            {
                ...
                spriteBatch.Draw(texture, positions[i], null, Color.White,
                    0, pos, 1.0F, SpriteEffects.None, depth);// depth = 1, back
